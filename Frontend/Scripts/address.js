...
const el = document.querySelector('ge-autocomplete')
    ...
    //   console.log(currentTarget)
      ...
      var lat="";
      var long="";
      window.lat=detail.geometry.coordinates[1];
      window.long=detail.geometry.coordinates[0];
    ...
    //   data = JSON.stringify(detail, undefined, 4);
    ...
    document.getElementById("btn").addEventListener('click',loadmore);
    ...
    function loadmore(e){
      ...
      document.getElementById("card").style.display="none";
      document.getElementById("btn2").value="Get Results";
      let meter="";
...
document.getElementById("local").innerText="Desired";
...
<div class="shadowbox">
  ...
  document.getElementById("descript").innerHTML=`<span>${descript}</span>`
...
.catch(e=>
  ...
  .catch(e => console.log(e));
    ...
    //   headers:new Headers({
    //     'Accept':'text/plain',
    //     'x-access-token':'eyJhbGciOiJIUzI1NiJ9.OTA5NTE1YjAtOTEzMC0xMWVjLTk1MDYtNTE4YTRjNDVlNzY3.HjLSwd76TkYEnAGo0Zz-e3f559bs3S45cBotuqEnF4k'
    //   })
    //}
    )
    .then(res=>{
